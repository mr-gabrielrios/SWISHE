...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_local
   ...
   if ( nbad == 0 ) then
     ...
     write(err_msg_local,'(a47,i7)') 'saturation vapor pressure table overflow 0d, nbad=', nbad
...
!-----------------------------------------------
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_local,'(a47,i7)') 'saturation vapor pressure table overflow 1d, nbad=', nbad
     if(fms_error_handler('lookup_es',err_msg_local,err_msg)) return
   endif
...
!-----------------------------------------------
   ...
   if ( nbad == 0 ) then
     ...
     if(show_bad_value_count_by_slice) call temp_check ( temp )
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_local,'(a47,i7)') 'saturation vapor pressure table overflow 2d, nbad=', nbad
     if(fms_error_handler('lookup_es',err_msg_local,err_msg)) return
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_tmp
   ...
   write(*,*) "7 calling sat vap init"
   if (.not.module_is_initialized) call sat_vapor_pres_init
   write(*,*) "7.1 done calling sat vap init"
   ...
   if ( nbad == 0 ) then
     ...
     if(show_bad_value_count_by_slice) call temp_check ( temp )
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_tmp,'(a47,i7)') 'saturation vapor pressure table overflow 3d, nbad=', nbad
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_local
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_local,'(a47,i7)') 'saturation vapor pressure table overflow ed2_0d, nbad=', nbad
...
!-----------------------------------------------
   ...
   if ( nbad == 0 ) then
     ...
     if(show_bad_value_count_by_slice) call temp_check ( temp )
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_local,'(a47,i7)') 'saturation vapor pressure table overflow es2_k, nbad=', nbad
     if(fms_error_handler('lookup_es2',err_msg_local,err_msg)) return
   endif
...
!-----------------------------------------------
   ...
   if ( nbad == 0 ) then
     ...
     if(show_bad_value_count_by_slice) call temp_check ( temp )
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_local,'(a47,i7)') 'saturation vapor pressure table overflow es2_2d, nbad=', nbad
     if(fms_error_handler('lookup_es2',err_msg_local,err_msg)) return
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_tmp
   ...
   if ( nbad == 0 ) then
     ...
     if(show_bad_value_count_by_slice) call temp_check ( temp )
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_tmp,'(a47,i7)') 'saturation vapor pressure table overflow es2_3d, nbad=', nbad
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_tmp
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_tmp,'(a47,i7)') 'saturation vapor pressure table overflow 0d, nbad=', nbad
...
!  call compute_qs_k (temp, press,  EPSILO, ZVIR, qsat, nbad, q, dqsdT)
   ...
   if ( nbad == 0 ) then
     ...
     if(show_bad_value_count_by_slice) call temp_check ( temp )
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_tmp,'(a47,i7)') 'saturation vapor pressure table overflow 1d, nbad=', nbad
     if(fms_error_handler('compute_qs',err_msg_tmp,err_msg)) return
   endif
...
!  call compute_qs_k (temp, press,  EPSILO, ZVIR, qsat, nbad, q, dqsdT)
   ...
   if ( nbad == 0 ) then
     ...
     if(show_bad_value_count_by_slice) call temp_check ( temp )
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_tmp,'(a47,i7)') 'saturation vapor pressure table overflow 2d, nbad=', nbad
     if(fms_error_handler('compute_qs',err_msg_tmp,err_msg)) return
   endif
...
!  call compute_qs_k (temp, press,  EPSILO, ZVIR, qsat, nbad, q, dqsdT)
   ...
   if ( nbad == 0 ) then
     ...
     if(show_bad_value_count_by_slice) call temp_check ( temp )
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_tmp,'(a57,i7)') 'saturation vapor pressure table overflow 3d, nbad=', nbad
     if(fms_error_handler('compute_qs',err_msg_tmp,err_msg)) return
   endif
...
subroutine show_all_bad_0d ( temp )
 ...
 if (ind < 0 .or. ind > nlim) then
   write(unit,'(a,e10.3,a,i6)') 'Bad temperature(0d)=',temp,' pe=',mpp_pe()
 endif
...
!--------------------------------------------------------------
 ...
 do i=1,size(temp)
   ind = int(dtinv*(temp(i)-tmin+teps))
   if (ind < 0 .or. ind > nlim) then
     write(unit,'(a,e10.3,a,i4,a,i6)') 'Bad temperature(1d)=',temp(i),'  at i=',i,' pe=',mpp_pe()
   endif
 enddo
...
!--------------------------------------------------------------
 ...
 do i=1,size(temp,1)
   ...
   if (ind < 0 .or. ind > nlim) then
     write(unit,'(a,e10.3,a,i4,a,i4,a,i6)') 'Bad temperature(2d)=',temp(i,j),'  at i=',i,' j=',j,' pe=',mpp_pe()
   endif
 enddo
 enddo
...
!--------------------------------------------------------------
 ...
 do i=1,size(temp,1)
   ...
   if (ind < 0 .or. ind > nlim) then
     write(unit,'(a,e10.3,a,i4,a,i4,a,i4,a,i6)') 'Bad temperature(3d)=',temp(i,j,k),'  at i=',i,' j=',j,' k=',k,' pe=',mpp_pe()
   endif
 enddo
 enddo
 enddo
